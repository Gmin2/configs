...
fish_add_path -a /home/mintu-ubuntu/.foundry/bin
...
export PATH="$PATH:/home/mintu-ubuntu/.local/bin"

# cre
set --export CRE_INSTALL "$HOME/.cre"
set --export PATH $CRE_INSTALL/bin $PATH
bass source /opt/ros/jazzy/setup.bash

export PATH="$PATH:/home/mintu-ubuntu/.risc0/bin"
